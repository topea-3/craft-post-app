...
import { PostcardSendManagePage } from './features/postcard-send/PostcardSendManagePage'
import { PostcardSendCreatePage } from './features/postcard-send/PostcardSendCreatePage'
import { PostcardSendDetailPage } from './features/postcard-send/PostcardSendDetailPage'
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'sends', element: <PostcardSendManagePage /> },
      { path: 'sends/new', element: <PostcardSendCreatePage /> },
